 ...
 */
  ...
  function drawNode(node) {
    ...
    var area = 10;
    draw_object.position.x = Math.floor(Math.random() * (area + area + 50) - area);
    draw_object.position.y = Math.floor(Math.random() * (area + area + 50) - area);
    draw_object.position.z = Math.floor(Math.random() * (area + area + 50) - area);
